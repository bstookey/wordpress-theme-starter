<?php
$address = cust_theme_option('org_address') ?: "";
$address2 = cust_theme_option('org_address2') ?: "";
$city = cust_theme_option('org_city') ?: "";
$state = cust_theme_option('org_state') ?: "";
$zip = cust_theme_option('org_zip') ?: "";
$country = cust_theme_option('org_country') ?: "";
...
<div class="address-block" itemscope itemtype="https://schema.org/Organization">
    ...
    <div class="address" itemprop="address" itemscope itemtype="https://schema.org/PostalAddress">
        ...
        <span class="visually-hidden" itemprop="addressCountry"><?= $country ?></span>
    </div>
    <?= $phone ?>
    <?= $fax ?>
    <?= $email ?>
